...
typealias MobileScannerCallback = (barcodes: List<Map<String, Any?>>, image: ByteArray?, width: Int?, height: Int?, sensorRotationDegrees : Int?, sensorRotationDegrees : Int?, originalWidth: Double?, originalHeight: Double?) -> Unit
